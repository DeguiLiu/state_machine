...
static const SM_Transition T1[] = {{1, &TEST_STATE_2, NULL, NULL, SM_TRANSITION_EXTERNAL}};

static const SM_State TEST_STATE_1 = {.parent = NULL,
...
static const SM_State TEST_STATE_2 = {.parent = NULL,
                                      .entryAction = test_entry,
                                      .exitAction = NULL,
                                      .transitions = NULL,
                                      .numTransitions = 0,
...
int main(void) {
    ...
    printf("   In State1: %s, In State2: %s\n", in_state1 ? "YES" : "NO", in_state2 ? "YES" : "NO");
