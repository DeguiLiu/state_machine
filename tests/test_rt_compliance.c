...
static const SM_Transition T_A[] = {{EV_TEST_1, &TEST_STATE_B, NULL, NULL, SM_TRANSITION_EXTERNAL}};

static const SM_Transition T_B[] = {{EV_TEST_2, &TEST_STATE_A, NULL, NULL, SM_TRANSITION_EXTERNAL}};

static const SM_State TEST_STATE_A = {.parent = NULL,
                                      .entryAction = entry_A,
                                      .exitAction = NULL,
                                      .transitions = T_A,
...
static const SM_State TEST_STATE_B = {.parent = NULL,
                                      .entryAction = entry_B,
                                      .exitAction = NULL,
                                      .transitions = T_B,
...
int main(void) {
    ...
    printf("   Result: %s, Is in StateA: %s\n",
           (result == SM_RT_RESULT_SUCCESS) ? "SUCCESS" : "FAILED", is_in_state ? "YES" : "NO");
